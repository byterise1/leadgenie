      ...
      <main>
        <section className="border-b border-gray-100 py-16 text-center">
          <div className="container max-w-3xl">
            ...
            <p className="mt-4 text-gray-600 text-base leading-relaxed max-w-2xl mx-auto">
              Lead Genie is committed to full compliance with the General Data Protection Regulation (GDPR).
        ...
        <section className="py-16">
          <div className="container max-w-3xl space-y-10">
            {[
              { title: 'Our Role Under GDPR', content: 'Lead Genie acts as both a data controller (for data about our users) and a data processor (for prospect data uploaded by customers). As a processor, we sign Data Processing Agreements (DPAs) with customers on request and process data only per their documented instructions.' },
              ...
              { title: 'Data Transfers Outside the EU', content: 'Lead Genie is headquartered in the United States. We transfer EU personal data to the US under Standard Contractual Clauses (SCCs) as approved by the European Commission. Our DPA includes all necessary SCCs.' },
