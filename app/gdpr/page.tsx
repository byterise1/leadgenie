        ...
        <section className="py-16">
          <div className="container max-w-3xl space-y-10">
            {[
              ...
              { title: 'Data Subject Rights', content: 'EU residents have the right to access, rectify, erase, restrict, or port their personal data. To exercise these rights, email dpo@leadsgenie.site. We respond within 30 days. You may also lodge a complaint with your national supervisory authority.' },
              ...
              { title: 'Data Processing Agreement', content: 'If you are a business customer subject to GDPR and need a DPA, email legal@leadsgenie.site. We provide DPAs at no charge and typically return a signed copy within 3 business days.' },
              { title: 'Contact Our DPO', content: 'Data Protection Officer: dpo@leadsgenie.site\nLeads Genie, Inc.\nEmail: legal@leadsgenie.site' },
            ].map(s => (
              <div key={s.title}>
