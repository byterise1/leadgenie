...
const PLAN_COLORS: Record<string, string> = {
  free: 'bg-gray-100 dark:bg-gray-800 text-gray-500',
    ...
    <main className="flex-1 p-6 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-0.5">Platform-wide overview and controls.</p>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
            <h2 className="text-sm font-bold text-gray-900 dark:text-white">Recent Signups</h2>
          ...
          {loading ? (
            ...
            <div className="px-6 py-12 text-center text-sm text-gray-400 dark:text-gray-500">No users yet.</div>
          ) : (
            <div className="divide-y divide-gray-50 dark:divide-gray-800">
              {stats.recentUsers.map(u => {
                ...
                return (
                  <Link key={u.id} href={`/admin/users?focus=${u.id}`}
                    className="flex items-center gap-3 px-6 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors group">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        <span className="text-[10px] text-gray-400 dark:text-gray-500">{u.credits_used}/{u.credits_total} credits</span>
                      </div>
                    </div>
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <h2 className="text-sm font-bold text-gray-900 dark:text-white mb-5">Platform Health</h2>
            <div className="space-y-4">
              {[
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <Link key={a.href} href={a.href}
                  ...
                  <span className="text-xs font-bold text-gray-700 dark:text-gray-200">{a.label}</span>
                </Link>
              ))}
            </div>
          </div>
