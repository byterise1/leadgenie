      ...
      <main>
        <section className="border-b border-gray-100 py-16 text-center">
          <div className="container max-w-3xl">
            ...
            <p className="mt-4 text-gray-600 text-base leading-relaxed max-w-2xl mx-auto">
              Lead Genie is a tool for professional outreach. We have zero tolerance for spam.
        ...
        <section className="py-16">
          <div className="container max-w-3xl space-y-10">
            {[
              { title: 'What Is Prohibited', content: `The following uses of Lead Genie are strictly prohibited and will result in immediate account termination:
...
• Using Lead Genie for phishing, malware distribution, or fraud
• Violating CAN-SPAM, GDPR, CASL, or any applicable anti-spam law` },
              { title: 'What Is Permitted', content: `Lead Genie is designed for legitimate business outreach, including:
...
All emails sent through Lead Genie must include a clear, functional unsubscribe mechanism. Opt-out requests must be honoured within 10 business days.` },
              ...
              { title: 'Reporting Spam', content: 'If you believe a Lead Genie customer is sending spam, please report it to abuse@leadgenie.io with a copy of the email including full headers. We investigate all reports and take swift action against violators.' },
