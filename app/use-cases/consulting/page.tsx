      ...
      <main>
        ...
        <section className="border-b border-gray-100 dark:border-gray-800">
          <div className="container px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 sm:grid-cols-4 border-l border-t border-gray-100 dark:border-gray-800">
              <div className="flex items-center gap-2 sm:gap-4 py-5 sm:py-8 px-3 sm:px-6 hover:bg-gray-50/60 dark:hover:bg-gray-800 transition-colors border-r border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="min-w-0">
                  <p className="text-lg sm:text-3xl font-extrabold tracking-tight leading-none" style={{ color: '#3b82f6' }}>1,200+</p>
                  <p className="text-xs font-bold text-gray-700 dark:text-gray-200 mt-0.5">Consulting Firms</p>
                </div>
              </div>
              <div className="flex items-center gap-2 sm:gap-4 py-5 sm:py-8 px-3 sm:px-6 hover:bg-gray-50/60 dark:hover:bg-gray-800 transition-colors border-r border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="min-w-0">
                  <p className="text-lg sm:text-3xl font-extrabold tracking-tight leading-none" style={{ color: '#10b981' }}>28%</p>
                  <p className="text-xs font-bold text-gray-700 dark:text-gray-200 mt-0.5">Discovery Call Rate</p>
                </div>
              </div>
              <div className="flex items-center gap-2 sm:gap-4 py-5 sm:py-8 px-3 sm:px-6 hover:bg-gray-50/60 dark:hover:bg-gray-800 transition-colors border-r border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="min-w-0">
                  <p className="text-lg sm:text-3xl font-extrabold tracking-tight leading-none" style={{ color: '#8b5cf6' }}>5×</p>
                  <p className="text-xs font-bold text-gray-700 dark:text-gray-200 mt-0.5">More Leads vs Referrals</p>
                </div>
              </div>
              <div className="flex items-center gap-2 sm:gap-4 py-5 sm:py-8 px-3 sm:px-6 hover:bg-gray-50/60 dark:hover:bg-gray-800 transition-colors border-r border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="min-w-0">
                  <p className="text-lg sm:text-3xl font-extrabold tracking-tight leading-none" style={{ color: '#f59e0b' }}>2 hrs</p>
                  <p className="text-xs font-bold text-gray-700 dark:text-gray-200 mt-0.5">Saved on Prospecting Daily</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20">
          <div className="container max-w-[1100px]">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white text-center mb-14">Stop relying only on referrals</h2>
        ...
        <section className="bg-gray-50 dark:bg-gray-800 py-20">
          <div className="container max-w-3xl text-center">
            <p className="text-xl text-gray-700 dark:text-gray-200 leading-relaxed italic">&ldquo;I used to spend 2 hours a day on LinkedIn looking for leads. Now Leads Genie does it automatically and I get 8–12 discovery calls booked every month on autopilot. My pipeline has never been healthier.&rdquo;</p>
            <div className="mt-6 flex items-center justify-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-gray-900 dark:text-white">David Marsh</p>
                <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-500">Principal, Marsh Strategy Group</p>
              </div>
            </div>
          </div>
        </section>
