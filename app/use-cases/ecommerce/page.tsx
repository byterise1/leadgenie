          ...
          <div className="container">
            <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-y sm:divide-y-0 divide-gray-100">
              <div className="flex items-center gap-4 py-8 px-6 hover:bg-gray-50/60 transition-colors">
                ...
                <div>
                  <p className="text-2xl sm:text-3xl font-extrabold tracking-tight leading-none" style={{ color: '#3b82f6' }}>3,000+</p>
              ...
              <div className="flex items-center gap-4 py-8 px-6 hover:bg-gray-50/60 transition-colors">
                ...
                <div>
                  <p className="text-2xl sm:text-3xl font-extrabold tracking-tight leading-none" style={{ color: '#10b981' }}>22%</p>
              ...
              <div className="flex items-center gap-4 py-8 px-6 hover:bg-gray-50/60 transition-colors">
                ...
                <div>
                  <p className="text-2xl sm:text-3xl font-extrabold tracking-tight leading-none" style={{ color: '#8b5cf6' }}>10×</p>
              ...
              <div className="flex items-center gap-4 py-8 px-6 hover:bg-gray-50/60 transition-colors">
                ...
                <div>
                  <p className="text-2xl sm:text-3xl font-extrabold tracking-tight leading-none" style={{ color: '#f59e0b' }}>48h</p>
