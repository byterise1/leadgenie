      ...
      <main>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 border-l border-t border-gray-100 dark:border-gray-800">
              <div className="flex items-center gap-2 sm:gap-4 py-5 sm:py-8 px-3 sm:px-6 hover:bg-gray-50/60 dark:hover:bg-gray-800 transition-colors border-r border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs font-bold text-gray-700 dark:text-gray-200 mt-0.5">E-commerce Brands</p>
                </div>
              </div>
              <div className="flex items-center gap-2 sm:gap-4 py-5 sm:py-8 px-3 sm:px-6 hover:bg-gray-50/60 dark:hover:bg-gray-800 transition-colors border-r border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs font-bold text-gray-700 dark:text-gray-200 mt-0.5">Avg Buyer Reply Rate</p>
                </div>
              </div>
              <div className="flex items-center gap-2 sm:gap-4 py-5 sm:py-8 px-3 sm:px-6 hover:bg-gray-50/60 dark:hover:bg-gray-800 transition-colors border-r border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs font-bold text-gray-700 dark:text-gray-200 mt-0.5">ROI vs Trade Shows</p>
                </div>
              </div>
              <div className="flex items-center gap-2 sm:gap-4 py-5 sm:py-8 px-3 sm:px-6 hover:bg-gray-50/60 dark:hover:bg-gray-800 transition-colors border-r border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs font-bold text-gray-700 dark:text-gray-200 mt-0.5">Setup to First Send</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20">
          <div className="container max-w-[1100px]">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white text-center mb-14">Built for e-commerce growth teams</h2>
        ...
        <section className="bg-gray-50 dark:bg-gray-800 py-20">
          <div className="container max-w-3xl text-center">
            <p className="text-xl text-gray-700 dark:text-gray-200 leading-relaxed italic">&ldquo;We opened 23 new wholesale accounts in 60 days using Leads Genie. Reaching retail buyers used to take months of trade shows — now we do it from our laptop with a 20% reply rate.&rdquo;</p>
            <div className="mt-6 flex items-center justify-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-gray-900 dark:text-white">Tom Kim</p>
                <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-500">Head of Wholesale, Brightleaf Goods</p>
              </div>
            </div>
          </div>
        </section>
