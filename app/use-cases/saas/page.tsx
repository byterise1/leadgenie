      ...
      <main>
        <section className="hero-gradient py-20 text-center">
          <div className="container max-w-3xl">
            ...
            <p className="mt-5 text-blue-100 text-lg max-w-xl mx-auto leading-relaxed">
              Reach your ideal users before they find your competitors. Leads Add helps SaaS
        ...
        <section className="bg-gray-50 py-20">
          <div className="container max-w-3xl text-center">
            <p className="text-xl text-gray-700 leading-relaxed italic">&ldquo;Our open rates jumped from 28% to 61% after switching to Leads Add. The AI personalisation is genuinely impressive — it sounds human on every email.&rdquo;</p>
