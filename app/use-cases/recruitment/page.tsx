      ...
      <main>
        ...
        <section className="bg-gray-50 py-20">
          <div className="container max-w-3xl text-center">
            <p className="text-xl text-gray-700 leading-relaxed italic">&ldquo;We used to spend hours on LinkedIn finding candidates. Now Leads Genie does it automatically and we spend our time on actual interviews. Our placement rate is up 40%.&rdquo;</p>
