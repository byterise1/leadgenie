      ...
      <main>
        ...
        <section className="border-b border-gray-100 dark:border-gray-800 py-16 text-center">
          <div className="container max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white leading-tight">Cookie Policy</h1>
        ...
        <section className="py-16">
          <div className="container max-w-3xl space-y-12">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Cookies We Use</h2>
              <div className="space-y-5">
                {cookieTypes.map(ct => (
                  <div key={ct.name} className="border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <h3 className="text-base font-bold text-gray-900 dark:text-white">{ct.name}</h3>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-3">{ct.desc}</p>
                    <div className="flex flex-wrap gap-2">
                      {ct.examples.map(ex => (
                        <span key={ex} className="text-xs bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-2.5 py-1 text-gray-500 dark:text-gray-500 dark:text-gray-500">{ex}</span>
                      ))}
                    </div>
                  </div>
                ))}
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={tp.name} className="flex items-center gap-3 text-sm">
                    <span className="font-semibold text-gray-900 dark:text-white w-36 shrink-0">{tp.name}</span>
                    <span className="text-gray-500 dark:text-gray-500 dark:text-gray-500">{tp.purpose}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Managing Your Cookie Preferences</h2>
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
