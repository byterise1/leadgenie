        ...
        <section className="border-b border-gray-100 py-16 text-center">
          <div className="container max-w-3xl">
            ...
            <p className="mt-4 text-gray-600 text-base leading-relaxed max-w-2xl mx-auto">
              At Leads Add, we take your privacy seriously. This policy explains what data we
...
• Usage data: how you interact with the Leads Add platform, features used, and session data
...
• Provide, operate, and improve the Leads Add platform
...
We do not sell your personal data to third parties. We do not use your prospect lists for our own marketing purposes.`,
                },
                {
                  ...
                  content: `When you upload prospect lists and run email campaigns through Leads Add, you are the data controller for that contact data. You are responsible for ensuring you have a lawful basis to contact those prospects and that your outreach complies with applicable laws (CAN-SPAM, GDPR, CASL, etc.).

Leads Add acts as a data processor for your prospect data. We process this data solely to deliver your campaigns and provide the service. We do not access, read, or use your prospect data for any other purpose.
...
• Legal requirements: We may disclose data if required by law, court order, or to protect the rights and safety of Leads Add and its users.
...
Despite these measures, no system is 100% secure. If you suspect unauthorised access to your account, contact security@leadgenie.io immediately.`,
                },
                {
                  title: '6. Your Rights',
...
To exercise any of these rights, email privacy@leadgenie.io. We will respond within 30 days. EU/UK residents may also lodge a complaint with their local data protection authority.`,
                },
                {
                  title: '7. Cookies',
...
You may request immediate deletion of your account and associated data at any time by emailing privacy@leadgenie.io.`,
                },
                {
                  title: '9. International Transfers',
                  content: `Leads Add is headquartered in the United States. If you are located in the EU, UK, or another region with data transfer restrictions, your data may be transferred to and processed in the United States. We rely on Standard Contractual Clauses (SCCs) approved by the European Commission for such transfers.`,
                },
                {
                  title: '10. Changes to This Policy',
                  content: `We may update this Privacy Policy from time to time. We will notify you of material changes via email or a prominent notice on the platform at least 14 days before the change takes effect. Your continued use of Leads Add after the effective date constitutes acceptance of the updated policy.`,
                },
                {
                  title: '11. Contact Us',
...
Data Protection Officer: dpo@leadgenie.io`,
                },
              ].map(section => (
