  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `Leads Genie supports built-in A/B testing on campaign steps.\n\nIn the campaign builder, enable the A/B toggle on any step to add a variant subject line. The system sends each variant to 50% of your leads and tracks which performs better in Analytics.`,
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `Every link in your emails is automatically wrapped with a tracking URL. When a recipient clicks it, Leads Genie records a click event.\n\nNote: Security scanners sometimes click all links in an email to check for malware. This can inflate click rates. Focus on reply rate as your primary signal.`,
      },
      {
        q: 'Exporting campaign reports',
        a: `Go to Analytics and click the Export CSV button at the top right to download your campaign data.\n\nThe export includes emails sent, open rate, click rate, reply rate, and bounce rate for each campaign.`,
      },
      {
        q: 'How are opens tracked?',
        a: `A tiny invisible 1x1 pixel image is inserted at the bottom of each email. When the recipient's email client loads images, the pixel fires and we record an open.\n\nGmail loads images through its own servers about 5-15 seconds after delivery. Leads Genie filters these out by only counting opens that happen 30+ seconds after send time, ensuring you only see real human opens.`,
      },
    ],
  },
  {
    ...
    articles: [
      ...
      {
        q: 'Refund policy',
        a: `Refunds are available within 7 days of purchase if you haven't used your account significantly.\n\nContact support with your account email and reason. We typically respond within 24 hours on business days.`,
      },
    ],
  },
];
