...
export const helpSections: HelpSection[] = [
  {
    ...
    articles: [
      {
        q: 'Creating your Leads Add account',
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `A tiny invisible 1×1 pixel image is inserted at the bottom of each email. When the recipient's email client loads images, the pixel fires and we record an open.\n\nGmail loads images through its own servers about 5–15 seconds after delivery (to protect user privacy). Leads Add filters these out by only counting opens that happen **30+ seconds after send time**, ensuring you only see real human opens.`,
      },
    ],
  },
  {
